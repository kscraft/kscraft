...
if( class_exists( 'Polylang' ) && !class_exists('ReyCore_Compatibility__Polylang') ):
	...
	class ReyCore_Compatibility__Polylang
	{
		...
		private function __construct()
		{
			...
			add_filter( 'reycore/elementor/gs_id', [$this, 'maybe_change_global_section_id'] );
		}
		...
		public function maybe_change_global_section_id( $post_id ){

			if( ! apply_filters('reycore/multilanguage/translate_ids', false) ){
				return $post_id;
			}

            if( $translated_id = pll_get_post($post_id, pll_current_language('slug')) ){
