    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <section className="py-20 bg-slate-950 text-white overflow-hidden relative">
        ...
        <div className="max-container relative z-10 px-6">
          <div className="mb-16">
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-blue-400">Knowledge Hub</span>
            ...
            {guides.map((guide) => (
              ...
              >
                <div className="flex justify-between items-start mb-10">
                  <span className="px-4 py-1.5 rounded-full bg-blue-600/20 text-[9px] font-black uppercase tracking-widest text-blue-400 border border-blue-500/30">
                    {guide.category}
                  </span>
                ...
                <span className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-blue-400 group-hover:gap-4 transition-all">
            ...
            {industries.map((industry) => (
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-8">
                  <p className="text-[9px] font-black uppercase tracking-widest text-blue-400 mb-2">{industry.eyebrow}</p>
