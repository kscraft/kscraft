...
if(!class_exists('ReyCoreElementor')):
	...
	final class ReyCoreElementor
	{
		...
		public function init_hooks(){
			...
			add_filter( 'rey/site_container/classes', [ $this, 'stretch_page'], 10);
		...
		/**
		 * Add stretch class to Rey's Page builder template, if enabled;
		 *
		 * @since 1.0.0
		 */
		public function stretch_page( $classes ){

			if( is_page_template('template-builder.php') &&
				$meta = get_post_meta( get_the_ID(), '_elementor_page_settings', true ) &&
				isset($meta['rey_stretch_page']) && ($stretch = $meta['rey_stretch_page']) && $stretch === 'rey-stretchPage' ){
				$classes[] = $stretch;
			}
