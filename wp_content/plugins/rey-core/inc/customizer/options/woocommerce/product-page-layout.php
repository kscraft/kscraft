...
ReyCoreKirki::add_field( 'rey_core_kirki', [
	...
	'label'       => esc_html__( 'Enable Fixed Summary', 'rey-core' ),
	'description' => __('This option will make the product summary fixed upon page scrolling, until the product gallery images are outside viewport.', 'rey-core'),
	'section'     => $section,
	'default'     => false,
	// 'priority'    => 50,
	'active_callback' => [
...
reycore_customizer__title([
	'title'       => esc_html__('Product Content (Blocks/Tabs)', 'rey-core'),
	'description' => esc_html__('Customize the product content.', 'rey-core'),
	'section'     => $section,
	'size'        => 'md',
	'border'      => 'top',
	'upper'       => true,
...
ReyCoreKirki::add_field( 'rey_core_kirki', [
	...
	'label'       => esc_html__( 'Content Layout', 'rey-core' ),
	'section'     => $section,
	'default'     => 'blocks',
	// 'priority'    => 140,
	'choices'     => [
