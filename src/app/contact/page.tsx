      ...
      <section className="py-32 mx-auto max-w-7xl px-6 lg:px-12 w-full">
        <div className="grid lg:grid-cols-12 gap-20">
          ...
          <div className="lg:col-span-5 space-y-20">
            <div>
              <h2 className="text-[10px] font-black text-blue-600 uppercase tracking-[0.4em] mb-12">{home.contact.hubsLabel}</h2>
            ...
            <div>
              <h2 className="text-[10px] font-black text-blue-600 uppercase tracking-[0.4em] mb-12">{home.contact.digitalLabel}</h2>
