...
class ADQ_PB extends WC_PB_Cart {
	...
	public function woo_bundles_item_subtotal( $subtotal, $values, $cart_item_key ) {
		...
		if ( isset( $values[ 'bundled_items' ] ) ) {
			...
			$bundle_price            = get_option( 'woocommerce_tax_display_cart' ) === 'excl' ? adq_get_price_excluding_tax( $values[ 'quantity' ] ) : adq_get_price_including_tax( $values[ 'quantity' ] );
			...
			foreach ( $values[ 'bundled_items' ] as $bundled_item_key ) {
				...
				$bundled_item_price = get_option( 'woocommerce_tax_display_cart' ) === 'excl' ? 
										adq_get_price_excluding_tax( $values[ 'quantity' ] ) : adq_get_price_including_tax( $values[ 'quantity' ] );
				...
				if ( isset( $bundled_item ) && $bundled_item && $bundled_item->is_sub() ) {
					...
					$bundled_item_prorated_fee = get_option( 'woocommerce_tax_display_cart' ) === 'excl' ? adq_get_price_excluding_tax( $product, $item_values[ 'quantity' ], $bundled_item->get_prorated_price_for_subscription( $product->get_price(), $product )) : adq_get_price_including_tax( $product, $item_values[ 'quantity' ], $bundled_item->get_prorated_price_for_subscription( $product->get_price(), $product ) );
