...
class ReyCore_Widget_Toggle_Boxes extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'distance',
			[
				'label' => __( 'Items Distance', 'rey-core' ),
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .rey-toggleBox.--active' => 'color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .rey-toggleBox.--active' => 'background-color: {{VALUE}}',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', 'em', '%' ],
				'selectors' => [
					'{{WRAPPER}} .rey-toggleBox.--active' => 'border-width: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'type' => \Elementor\Controls_Manager::COLOR,
				'selectors' => [
					'{{WRAPPER}} .rey-toggleBox.--active' => 'border-color: {{VALUE}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .rey-toggleBox.--active',
			]
		);
	...
	protected function render() {
		...
		if( !empty($settings['items']) ){
			foreach ($settings['items'] as $key => $item) {
				printf(
					'<div class="rey-toggleBox %2$s"><span class="rey-toggleBox-text-main">%1$s</span></div>',
					$item['text'],
					$key == 0 ? '--active': ''
				);
			}
