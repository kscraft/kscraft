...
class ADQ_Sections_Quotelist extends WC_Settings_Page {
	...
	public function get_settings() {
		...
		$settings = array(
			...
			array( 'title' => __( 'Shipping', 'woocommerce-quotation' ), 'type' => 'title', 'desc' => '', 'id' => 'adq_options' ),
				...
				'type'          => 'select',
				'options'		=> array(
					'disable'	=> __( 'Disable shipping', 'woocommerce-quotation' ),
					'enable'	=> __( 'Enable shipping', 'woocommerce-quotation' ),
					'user'		=> __( 'Enable shipping by user\'s choice', 'domain' )
				)
			),                   
                    
                        array(
				'title'         => __( 'Hide shipping costs', 'woocommerce' ),
				'id'            => 'adq_hide_shipping_costs',
				'default'       => 'no',
				'type'          => 'checkbox',
				'checkboxgroup' => 'start'
			),
            ...
            array(
                'title'             => __( 'Reset shipping settings', 'woocommerce-quotation' ),
                'desc'              => '',
                'id'                => 'adq_reset_shipping_settings',
                'type'              => 'button',
                'text'              => __( 'Reset', 'woocommerce-quotation' ),
                'custom_attributes' => array(
                    'data-confirm'          => '',
                    'data-confirm-message'  => __( 'Are you sure to reset the settings of shipping options?', 'woocommerce-quotation' )
                )
            )
        );
	...
	public function save() {
        ...
        if ( isset($_POST['adq_reset_shipping_settings'] ) ) {
            $data = array();
