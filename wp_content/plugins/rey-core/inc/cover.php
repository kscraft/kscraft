	...
	class ReyCore_PageCover
	{
		...
		public function inherit_category_cover($cover){
			...
			if( is_tax( 'product_cat' ) &&
				($cat = get_queried_object()) &&  0 < $cat->parent &&
				($acf_page_cover = reycore__acf_get_field('page_cover', get_term_by('term_taxonomy_id', $cat->parent) ))
			) {
				return absint($acf_page_cover);
			}
