...
class ReyCore_Wc_ExtraVariationImages
{
	...
	public function __construct()
	{
		...
		add_action( 'reycore/kirki_fields/after_field=shop_thumbnails_padding', [ $this, 'add_customizer_options' ] );
