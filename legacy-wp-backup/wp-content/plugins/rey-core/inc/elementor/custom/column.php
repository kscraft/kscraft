	...
	class ReyCore_Element_Column {
		...
		function layout_settings( $element )
		{
			...
			$element->add_responsive_control(
				'rey_custom_height',
				[
					'label' => __( 'Minimum Height', 'rey-core' ),
			...
			$element->add_responsive_control(
				'rey_custom_width',
				[
					'label' => __( 'Custom Width', 'rey-core' ),
			...
			$element->add_responsive_control(
				'rey_col_order',
				[
					'label' => __( 'Column Order', 'rey-core' ),
		...
		function effects_settings( $element )
		{
			...
			if( ReyCoreElementor::animations_enabled() ):
				...
				$element->add_control(
					'rey_animation_type',
					[
						'label' => __( 'Entrance Effect', 'rey-core' ),
						'type' => \Elementor\Controls_Manager::SELECT,
						'default' => '',
						'options' => [
							''  => __( '- Select -', 'rey-core' ),
		...
		function section_advanced( $stack )
		{
			...
			$stack->add_control(
				'rey_utility_classes',
				[
					'label' => esc_html__( 'Utility Classes (rey)', 'rey-core' ),
					'type' => \Elementor\Controls_Manager::SELECT,
					'default' => '',
					'options' => [
