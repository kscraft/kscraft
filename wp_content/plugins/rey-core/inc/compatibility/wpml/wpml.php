...
if( class_exists( 'SitePress' ) && !class_exists('ReyCore_Compatibility__Wpml') ):
	...
	class ReyCore_Compatibility__Wpml
	{
		...
		private function __construct()
		{
			...
			add_filter( 'reycore/elementor/gs_id', [$this, 'maybe_change_global_section_id'], 10, 2 );
         ...
         */
        public function maybe_change_global_section_id( $post_id, $post_type ) {

			if( ! apply_filters('reycore/multilanguage/translate_ids', false) ){
				return $post_id;
			}

            if( $translated_id = apply_filters( 'wpml_object_id', $post_id, $post_type, true ) ){
